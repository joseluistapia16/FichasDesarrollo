...
public class Menu_Pico extends javax.swing.JDialog {
    ...
    public Menu_Pico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public Menu_Pico(java.awt.Frame parent, boolean modal, Usuario obj) {
        super(parent, modal);
        setUndecorated(true);  // Quitar la decoración de la ventana
...
//        gficha.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Pico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Menu_Pico dialog = new Menu_Pico(new javax.swing.JFrame(), true);
